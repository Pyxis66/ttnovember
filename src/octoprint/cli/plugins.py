...
from octoprint.cli import pass_octoprint_ctx, TTNovemberContext, get_ctx_obj_option

#~~ "octoprint plugin:command" commands

class TTNovemberPluginCommands(click.MultiCommand):
	"""
...
@plugin_commands.group(name="plugins", cls=TTNovemberPluginCommands)
def plugins():
