(function (global, factory) {
    ...
    var TTNovemberSoftwareUpdateClient = function(base) {
        this.base = base;
    ...
    TTNovemberSoftwareUpdateClient.prototype.checkEntries = function(entries, force, opts) {
    ...
    TTNovemberSoftwareUpdateClient.prototype.check = function(force, opts) {
        if (arguments.length == 1 && _.isObject(arguments[0])) {
            var params = arguments[0];
            force = params.force;
            opts = params.opts;
    ...
    TTNovemberSoftwareUpdateClient.prototype.update = function(entries, force, opts) {
        if (arguments.length == 1 && _.isObject(arguments[0])) {
            var params = arguments[0];
            entries = params.entries;
            force = params.force;
    ...
    TTNovemberSoftwareUpdateClient.prototype.updateAll = function(force, opts) {
        if (arguments.length == 1 && _.isObject(arguments[0])) {
            var params = arguments[0];
            force = params.force;
            opts = params.opts;
    ...
    TTNovemberClient.registerPluginComponent("softwareupdate", TTNovemberSoftwareUpdateClient);
    return TTNovemberSoftwareUpdateClient;
});
...
$(function() {
    function SoftwareUpdateViewModel(parameters) {
        ...
        self.fromCheckResponse = function(data, ignoreSeen, showIfNothingNew) {
            ...
            if (data.status == "updateAvailable" || data.status == "updatePossible") {
                ...
                if (!self.loginState.isAdmin()) {
                    text += "<p><small>" + gettext("To have updates applied, get in touch with an administrator of this TTNovember instance.") + "</small></p>";
                }
                ...
                if ((ignoreSeen || !self._hasNotificationBeenSeen(data.information)) && !TTNovember.coreui.wizardOpen) {
        ...
        self.performCheck = function(showIfNothingNew, force, ignoreSeen) {
            ...
            self.checking(true);
            TTNovember.plugins.softwareupdate.check(force)
                .done(function(data) {
        ...
        self.performUpdate = function(force, items) {
            ...
            TTNovember.plugins.softwareupdate.updateAll(force, items)
                .done(function(data) {
        ...
        self.onDataUpdaterPluginMessage = function(plugin, data) {
            ...
            switch (messageType) {
                ...
                case "restart_manually": {
                    ...
                    text = gettext("The update finished successfully, please restart TTNovember now.");
                ...
                case "restart_failed": {
                    restartType = messageData.restart_type;
                    text = gettext("Restarting TTNovember failed, please restart it manually. You might also want to consult the log file on what went wrong here.");
                    if (restartType == "environment") {
