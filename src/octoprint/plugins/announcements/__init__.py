...
class AnnouncementPlugin(octoprint.plugin.AssetPlugin,
	...
	def get_settings_defaults(self):
		settings = dict(channels=dict(_important=dict(name="Important Announcements",
		                                              description="Important announcements about TTNovember.",
		                                              priority=1,
		                                              type="rss",
		                                              url="http://octoprint.org/feeds/important.xml"),
		                              _releases=dict(name="Release Announcements",
		                                             description="Announcements of new releases and release candidates of TTNovember.",
		                                             priority=2,
		                                             type="rss",
		                                             url="http://octoprint.org/feeds/releases.xml"),
		                              _blog=dict(name="On the OctoBlog",
		                                         description="Development news, community spotlights, TTNovember On Air episodes and more from the official OctoBlog.",
		                                         priority=2,
		                                         type="rss",
		                              ...
		                              _octopi=dict(name="OctoPi News",
		                                           description="News around OctoPi, the Raspberry Pi image including TTNovember.",
		                                           priority=2,
		                                           type="rss",
...
__plugin_description__ = "Announcements all around TTNovember"
__plugin_disabling_discouraged__ = gettext("Without this plugin you might miss important announcements "
                                           "regarding security or other critical issues concerning TTNovember.")
