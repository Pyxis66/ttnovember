(function (global, factory) {
    ...
    var TTNovemberPluginManagerClient = function(base) {
        this.base = base;
    };

    TTNovemberPluginManagerClient.prototype.get = function(refresh, opts) {
    ...
    TTNovemberPluginManagerClient.prototype.getWithRefresh = function(opts) {
        return this.get(true, opts);
    };

    TTNovemberPluginManagerClient.prototype.getWithoutRefresh = function(opts) {
        return this.get(false, opts);
    };

    TTNovemberPluginManagerClient.prototype.install = function(pluginUrl, dependencyLinks, opts) {
        var data = {
            url: pluginUrl,
    ...
    TTNovemberPluginManagerClient.prototype.reinstall = function(plugin, pluginUrl, dependencyLinks, opts) {
        var data = {
            url: pluginUrl,
            dependency_links: !!dependencyLinks,
            reinstall: plugin,
    ...
    TTNovemberPluginManagerClient.prototype.uninstall = function(plugin, opts) {
        var data = {
            plugin: plugin
        };
    ...
    TTNovemberPluginManagerClient.prototype.enable = function(plugin, opts) {
        var data = {
            plugin: plugin
        };
    ...
    TTNovemberPluginManagerClient.prototype.disable = function(plugin, opts) {
        var data = {
            plugin: plugin
        };
    ...
    TTNovemberPluginManagerClient.prototype.upload = function(file) {
        return this.base.upload(this.base.getBlueprintUrl("pluginmanager") + "upload_archive", file);
    };

    TTNovemberClient.registerPluginComponent("pluginmanager", TTNovemberPluginManagerClient);
    return TTNovemberPluginManagerClient;
});
...
$(function() {
    function PluginManagerViewModel(parameters) {
        ...
        self.requestData = function(options) {
            ...
            TTNovember.plugins.pluginmanager.get({repo: options.refresh_repo, notices: options.refresh_notices})
                .done(function(data) {
        ...
        self.togglePlugin = function(data) {
            ...
            if (self._getToggleCommand(data) == "enable") {
                ...
                TTNovember.plugins.pluginmanager.enable(data.key)
                    .done(onSuccess)
                    .fail(onError);
            } else {
                var perform = function() {
                    TTNovember.plugins.pluginmanager.disable(data.key)
                        .done(onSuccess)
                        .fail(onError);
                };
        ...
        self.installPlugin = function(url, name, reinstall, followDependencyLinks) {
            ...
            if (reinstall) {
                TTNovember.plugins.pluginmanager.reinstall(reinstall, url, followDependencyLinks)
                    .done(onSuccess)
                    .fail(onError);
            } else {
                TTNovember.plugins.pluginmanager.install(url, followDependencyLinks)
                    .done(onSuccess)
                    .fail(onError);
            }
        };
        ...
        self.uninstallPlugin = function(data) {
            ...
            TTNovember.plugins.pluginmanager.uninstall(data.key)
                .done(function() {
                    self.requestData();
                })
                .fail(function() {
                        ...
                        options.confirm = {
                            ...
                            buttons: [{
                                ...
                                click: function (notice) {
                                    ...
                                    restartClicked = true;
                                    showConfirmationDialog({
                                        message: gettext("This will restart your TTNovember server."),
                                        onproceed: function() {
                                            TTNovember.system.executeCommand("core", "restart")
                                                .done(function() {
                                                    notice.remove();
                                                    new PNotify({
            ...
            if (messageType == "loglines" && self.working()) {
                ...
                if (action == "install") {
                    ...
                    if (unknown) {
                        ...
                        textSuccess = gettext("A plugin was installed successfully, however it was impossible to detect which one. Please Restart TTNovember to make sure everything will be registered properly");
                        ...
                        textRestart = gettext("The plugin was reinstalled successfully, however a restart of TTNovember is needed for that to take effect.");
                        ...
                        textRestart = gettext("The plugin was installed successfully, however a restart of TTNovember is needed for that to take effect.");
                    ...
                    textRestart = gettext("The plugin was uninstalled successfully, however a restart of TTNovember is needed for that to take effect.");
                    ...
                    textRestart = gettext("The plugin was enabled successfully, however a restart of TTNovember is needed for that to take effect.");
                    ...
                    textRestart = gettext("The plugin was disabled successfully, however a restart of TTNovember is needed for that to take effect.");
