$(function() {
    function CuraViewModel(parameters) {
        ...
        self.removeProfile = function(data) {
            ...
            TTNovember.slicing.deleteProfileForSlicer("cura", data.key, {url: data.resource()})
                .done(function() {
                    self.requestData();
                    self.slicingViewModel.requestData();
                });
        ...
        self.makeProfileDefault = function(data) {
            ...
            TTNovember.slicing.updateProfileForSlicer("cura", data.key, {default: true}, {url: data.resource()})
                .done(function() {
                    self.requestData();
                });
        };
        ...
        self.testEnginePath = function() {
            TTNovember.util.testExecutable(self.settings.plugins.cura.cura_engine())
