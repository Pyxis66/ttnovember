$(function() {
    function CoreWizardAclViewModel(parameters) {
        ...
        self.disableAccessControl = function() {
            var message = gettext("If you disable Access Control <strong>and</strong> your TTNovember installation is accessible from the internet, your printer <strong>will be accessible by everyone - that also includes the bad guys!</strong>");
        ...
        self._sendData = function(data, callback) {
            TTNovember.postJson("plugin/corewizard/acl", data)
                .done(function() {
                    self.setup(true);
    ...
    function CoreWizardPrinterProfileViewModel(parameters) {
        ...
        self.onWizardDetails = function(response) {
            ...
            TTNovember.printerprofiles.get("_default")
                .done(function(data) {
        ...
        self.onWizardFinish = function() {
            ...
            TTNovember.printerprofiles.update("_default", self.editor.toProfileData())
                .done(function() {
