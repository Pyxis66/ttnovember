$(function() {
        ...
        //~~ TTNovember client setup
        TTNovember.options.baseurl = BASEURL;
        TTNovember.options.apikey = UI_API_KEY;

        var l10n = getQueryParameterByName("l10n");
        if (l10n) {
            TTNovember.options.locale = l10n;
        }

        TTNovember.socket.onMessage("connected", function(data) {
            var payload = data.data;
            TTNovember.options.apikey = payload.apikey;
        ...
        //~~ some CoreUI specific stuff we put into TTNovember.coreui

        TTNovember.coreui = (function() {
            var exports = {
        ...
        log.debug("Browser enviroment:", TTNovember.coreui.browser);
        ...
        var onTabChange = function(current, previous) {
            log.debug("Selected TTNovember tab changed: previous = " + previous + ", current = " + current);
            TTNovember.coreui.selectedTab = current;
        ...
        var bindViewModels = function() {
            ...
            TTNovember.coreui.onBrowserVisibilityChange(function(status) {
