    ...
    function TimelapseViewModel(parameters) {
        ...
        self.removeFile = function(filename) {
            var perform = function() {
                TTNovember.timelapse.delete(filename)
                    .done(function() {
        ...
        self.removeUnrendered = function(name) {
            var perform = function() {
                TTNovember.timelapse.deleteUnrendered(name)
                    .done(function() {
        ...
        self._bulkRemove = function(files, type) {
            ...
            if (type === "files") {
                ...
                handler = function(filename) {
                    return TTNovember.timelapse.delete(filename)
                        .done(function() {
                ...
                handler = function(filename) {
                    return TTNovember.timelapse.deleteUnrendered(filename)
                        .done(function() {
                            deferred.notify(_.sprintf(gettext("Deleted %(filename)s..."), {filename: filename}), true);
                        })
                        .fail(function() {
        ...
        self.renderUnrendered = function(name) {
            TTNovember.timelapse.renderUnrendered(name)
        ...
        self.save = function() {
            ...
            TTNovember.timelapse.saveConfig(payload)
                .done(self.fromResponse);
        };
