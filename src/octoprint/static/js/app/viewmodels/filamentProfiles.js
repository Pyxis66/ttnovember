$(function() {
    ...
    function PrinterProfilesViewModel() {
        ...
        self.requestData = function() {
            return TTNovember.printerprofiles.list()
        ...
        self.addProfile = function(callback) {
            ...
            TTNovember.printerprofiles.add(profile)
                .done(function() {
        ...
        self.removeProfile = function(data) {
            var perform = function() {
                self.requestInProgress(true);
                TTNovember.printerprofiles.delete(data.id, {url: data.resource})
                    .done(function() {
                        self.requestData()
                            .always(function() {
                                self.requestInProgress(false);
        ...
        self.updateProfile = function(profile, callback) {
            ...
            self.requestInProgress(true);
            TTNovember.printerprofiles.update(profile.id, profile)
                .done(function() {
                    if (callback !== undefined) {
                        callback();
                    }
