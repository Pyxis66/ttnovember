$(function() {
    function LoginStateViewModel() {
        ...
        self.reloadUser = function() {
            ...
            return TTNovember.users.get(self.currentUser().name)
                .done(self.updateCurrentUserData);
        };

        self.requestData = function() {
            return TTNovember.browser.passiveLogin()
        ...
        self.login = function(u, p, r) {
            ...
            return TTNovember.browser.login(username, password, remember)
        ...
        self.logout = function() {
            return TTNovember.browser.logout()
                .done(function(response) {
