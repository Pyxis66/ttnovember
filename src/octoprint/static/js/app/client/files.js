(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        factory(global.TTNovemberClient, global.$, global._);
    }
})(this, function(TTNovemberClient, $, _) {
    var url = "api/files";
    var downloadUrl = "downloads/files";

    var TTNovemberFilesClient = function(base) {
        this.base = base;
    };
    ...
    TTNovemberFilesClient.prototype.get = function(location, entryname, opts) {
        return this.base.get(resourceForEntry(location, entryname), opts);
    };

    TTNovemberFilesClient.prototype.list = function (recursively, force, opts) {
    ...
    TTNovemberFilesClient.prototype.listForLocation = function (location, recursively, opts) {
        recursively = recursively || false;
        return this.base.getWithQuery(resourceForLocation(location), {recursive: recursively}, opts)
            .done(preProcessList);
    };

    TTNovemberFilesClient.prototype.issueEntryCommand = function(location, entryname, command, data, opts) {
        var url = resourceForEntry(location, entryname);
        return this.base.issueCommand(url, command, data, opts);
    };

    TTNovemberFilesClient.prototype.select = function (location, path, print, opts) {
        print = print || false;
    ...
    TTNovemberFilesClient.prototype.analyse = function (location, path, parameters, opts) {
        return this.issueEntryCommand(location, path, "analyse", parameters || {}, opts);
    };

    TTNovemberFilesClient.prototype.slice = function (location, path, parameters, opts) {
        return this.issueEntryCommand(location, path, "slice",
            parameters || {}, opts);
    };

    TTNovemberFilesClient.prototype.delete = function (location, path, opts) {
        return this.base.delete(resourceForEntry(location, path), opts);
    };

    TTNovemberFilesClient.prototype.copy = function(location, path, destination, opts) {
        return this.issueEntryCommand(location, path, "copy", { destination: destination }, opts);
    };

    TTNovemberFilesClient.prototype.move = function(location, path, destination, opts) {
        return this.issueEntryCommand(location, path, "move", { destination: destination }, opts);
    };

    TTNovemberFilesClient.prototype.createFolder = function (location, name, path, opts) {
    ...
    TTNovemberFilesClient.prototype.upload = function (location, file, data) {
        data = data || {};
    ...
    TTNovemberFilesClient.prototype.download = function(location, path, opts) {
        return this.base.download(downloadForEntry(location, path), opts);
    };

    TTNovemberFilesClient.prototype.pathForEntry = function(entry) {
    ...
    TTNovemberFilesClient.prototype.entryForPath = function(path, root) {
        if (_.isArray(root)) {
            root = {children: root};
        }
    ...
    TTNovemberFilesClient.prototype.pathForElement = function(element) {
    ...
    TTNovemberFilesClient.prototype.elementByPath = function(location, startElement) {
        // TODO Remove in 1.4.x
    ...
    TTNovemberClient.registerComponent("files", TTNovemberFilesClient);
    return TTNovemberFilesClient;
});
