# coding=utf-8
"""
In this module resides the core data structures and logic of the plugin system. It is implemented in an TTNovember-agnostic
		...
		for group in groups:
			for entry_point in working_set.iter_entry_points(group=group, name=None):
				...
				if plugin:
					...
					# plugin is manageable if its location is writable and TTNovember
