	...
	def _monitor(self):
		...
		while self._monitoring_active:
			...
			try:
				...
				self._logger.exception("Something crashed inside the serial connection loop, please report this in TTNovember's bug tracker:")
