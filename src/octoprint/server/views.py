...
def index():
	...
	def default_view():
		...
		def make_default_ui():
			r = make_response(render_template("index2.jinja2", **render_kwargs))
			if wizard:
...
def _process_templates():
	...
	templates["tab"]["entries"] = dict(
		commandcenter=(gettext("CommandCenter"), dict(template="tabs/commandcenter.jinja2", _div="commandcenter")),
	...
	templates["settings"]["entries"] = dict(
		...
		filamentProfile=(gettext("Filaments"), dict(template="dialogs/settings/filamentProfile.jinja2", _div="settings_filamentProfile", custom_bindings=False)),
		...
		section_octoprint=(gettext("TTNovember"), None),
	...
	templates["about"]["entries"] = dict(
		about=("About TTNovember", dict(template="dialogs/about/about.jinja2", _div="about_about", custom_bindings=False)),
		#license=("TTNovember License", dict(template="dialogs/about/license.jinja2", _div="about_license", custom_bindings=False)),
