...
def _get_core_command_specs():
	...
	commands = collections.OrderedDict(
		...
		restart=dict(
			...
			name=gettext("Restart TTNovember"),
			confirm=gettext("You are about to restart the TTNovember server.")),
		restart_safe=dict(
			command=s().get(["server", "commands", "serverRestartCommand"]),
			name=gettext("Restart TTNovember in safe mode"),
			confirm=gettext("You are about to restart the TTNovember server in safe mode."),
