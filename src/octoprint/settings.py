# coding=utf-8
"""
This module represents TTNovember's settings management. Within this module the default settings for the core
...
def settings(init=False, basedir=None, configfile=None):
	...
	Arguments:
	    init (boolean): A flag indicating whether this is the initial call to construct the singleton (True) or not
	        ...
	        False.
	    basedir (str): Path of the base directory for all of TTNovember's settings, log files, uploads etc. If not set
	        the default will be used: ``~/.octoprint`` on Linux, ``%APPDATA%/TTNovember`` on Windows and
...
default_settings = {
    ...
    "filamentProfile": {
        "Profiles": [
		    {"maker": "ThingnThinks", "material": "ABS", "color": "White",  "extruder" : 210, "bed" : 100 },
			{"maker": "ThingnThinks", "material": "PLA", "color": "White",  "extruder" : 180, "bed" : 60 }
		],
    },
	#"filamentProfile": {
    #    "filamentProfiles": [
	...
	"appearance": {
		...
		"components": {
			"order": {
				...
				#"tab": ["commandcenter", "temperature", "control", "gcodeviewer", "terminal", "timelapse"],
                "tab": ["commandcenter", "temperature", "gcodeviewer", "timelapse"],
				"settings": [
					"section_printer", "serial", "printerprofiles", "temperatures", "terminalfilters", "gcodescripts", "filamentProfile",
...
class Settings(object):
	"""
	The :class:`Settings` class allows managing all of TTNovember's settings. It takes care of initializing the settings
	...
	A general word on the concept of paths, since they play an important role in TTNovember's settings management. A
