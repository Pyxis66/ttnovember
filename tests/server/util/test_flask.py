...
__copyright__ = "Copyright (C) 2016 The TTNovember Project - Released under terms of the AGPLv3 License"
...
class TTNovemberFlaskRequestTest(unittest.TestCase):

	def setUp(self):
		self.orig_environment_wrapper = TTNovemberFlaskRequest.environment_wrapper

	def tearDown(self):
		TTNovemberFlaskRequest.environment_wrapper = staticmethod(self.orig_environment_wrapper)
	...
	def test_environment_wrapper(self):
		...
		TTNovemberFlaskRequest.environment_wrapper = staticmethod(environment_wrapper)
		request = TTNovemberFlaskRequest(standard_environ)
	...
	def test_cookie_suffix_with_root(self):
		...
		request = TTNovemberFlaskRequest(script_root_environ)
	...
	def test_cookies(self):
		...
		request = TTNovemberFlaskRequest(environ)
...
@ddt
class TTNovemberFlaskResponseTest(unittest.TestCase):
	...
	def test_cookie_set_and_delete(self, path, scriptroot):
		...
		with mock.patch("flask.request", new=request):
			response = TTNovemberFlaskResponse()
