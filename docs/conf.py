# -*- coding: utf-8 -*-
#
# TTNovember documentation build configuration file, created by
...
htmlhelp_basename = 'TTNovemberdoc'
...
#latex_documents = [
#  ('index', 'TTNovember.tex', u'TTNovember Documentation',
...
man_pages = [
    ('index', 'octoprint', u'TTNovember Documentation',
     [u'Gina Häußge'], 1)
]
...
texinfo_documents = [
  ('index', 'TTNovember', u'TTNovember Documentation',
   u'Gina Häußge', 'TTNovember', 'One line description of project.',
   'Miscellaneous'),
]
