...
:mod:`TTNovemberClient.connection`
---------------------------------

.. js:function:: TTNovemberClient.connection.getSettings(opts)
...
.. js:function:: TTNovemberClient.connection.connect(data, opts)
...
.. js:function:: TTNovemberClient.connection.disconnect(opts)
...
.. js:function:: TTNovemberClient.connection.fakeAck(opts)
