...
.. js:function:: TTNovemberClient.printer.getFullState(flags, opts)
...
.. js:function:: TTNovemberClient.printer.getToolState(flags, opts)
...
.. js:function:: TTNovemberClient.printer.setToolTargetTemperatures(targets, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.setToolTargetTemperatures({"tool0": 220, "tool1": 205});
...
.. js:function:: TTNovemberClient.printer.setToolTemperatureOffsets(offsets, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.setToolTemperatureOffsets({"tool0": 10, "tool1": -5});
...
.. js:function:: TTNovemberClient.printer.selectTool(tool, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.selectTool("tool1")
          .done(function(response) {
              TTNovember.printer.extrude(5.0)
                  .done(function(response) {
                      TTNovember.printer.selectTool("tool0");
                  });
          });
...
.. js:function:: TTNovemberClient.printer.extrude(amount, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.extrude(5.0)
          .done(function(response) {
              TTNovember.printer.extrude(-2.0);
          });
...
.. js:function:: TTNovemberClient.printer.setFlowrate(factor, opts)
...
.. js:function:: TTNovemberClient.printer.getBedState(data, opts)
...
.. js:function:: TTNovemberClient.printer.setBedTargetTemperature(target, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.setBedTargetTemperature(90.0);
...
.. js:function:: TTNovemberClient.printer.setBedTemperatureOffset(offset, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.setBedTemperatureOffset(-5);
...
.. js:function:: TTNovemberClient.printer.jog(amounts, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.jog({"x", 10.0});

   Jog Y by -5mm and Z by 0.2mm.

   .. code-block:: javascript

      TTNovember.printer.jog({"y": -5.0, "z": 0.2});
...
.. js:function:: TTNovemberClient.printer.home(axes, opts)
   ...
   **Example:**
   ...
   .. code-block:: javascript
      ...
      TTNovember.printer.home(["x", "y"]);

   Home the Z axis.

   .. code-block:: javascript

      TTNovember.printer.home(["z"]);
...
.. js:function:: TTNovemberClient.printer.setFeedrate(factor, opts)
...
.. js:function:: TTNovemberClient.printer.getSdState(opts)
...
.. js:function:: TTNovemberClient.printer.initSd(opts)
...
.. js:function:: TTNovemberClient.printer.refreshSd(opts)
...
.. js:function:: TTNovemberClient.printer.releaseSd(opts)
