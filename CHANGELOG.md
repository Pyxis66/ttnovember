...
### Bug fixes
  ...
  * [#1893](https://github.com/foosel/TTNovember/issues/1893) - CuraEngine plugin: Fixed handling of multiple consecutive uploads of slicing profiles (see also [#1894](https://github.com/foosel/TTNovember/issues/1894))
...
([Commits](https://github.com/foosel/TTNovember/compare/1.2.13...1.2.14))
...
([Commits](https://github.com/foosel/TTNovember/compare/1.2.11...1.2.12))
...
### Improvements
  ...
  * Browser tab visibility is now tracked by the web interface, disabling the
    ...
    [#1065](https://github.com/foosel/TTNovember/issues/1065), the final verdict
...
([Commits](https://github.com/foosel/TTNovember/compare/1.2.7...1.2.8))
...
([Commits](https://github.com/foosel/TTNovember/compare/1.2.6...1.2.7))
...
([Commits](https://github.com/foosel/TTNovember/compare/1.2.3...1.2.4))
...
* Bundled [Software Update Plugin](https://github.com/foosel/TTNovember/wiki/Plugin:-Software-Update) takes care of notifying
  about new TTNovember releases and also allows updating if configured as such. Plugins may register themselves with the
...
* "Print time left" is now not displayed until it becomes somewhat stable. Display in web interface now also happens
  ...
  TTNovember will use data from prior prints to enhance the initial print time estimation.
...
* Better handling of errors on the websocket - no more logging of the full stack trace to the log, only a warning
  message for now.
* Daemonized TTNovember now cleans up its pidfile when receiving a TERM signal ([#711](https://github.com/foosel/TTNovember/issues/711))
* Added serial types for OpenBSD ([#551](https://github.com/foosel/TTNovember/pull/551))
* Improved behaviour of terminal:
  * Disabling autoscrolling now also stops cutting off the log while it's enabled, effectively preventing log lines from
    being modified at all ([#735](https://github.com/foosel/TTNovember/issues/735))
  * Applying filters displays ``[...]`` where lines where removed and doesn't cause scrolling on filtered lines
    anymore ([#286](https://github.com/foosel/TTNovember/issues/286))
...
* Frame rate for timelapses can now be configured per timelapse ([#782](https://github.com/foosel/TTNovember/pull/782))
* Added an option to specify the amount of encoding threads for FFMPEG ([#785](https://github.com/foosel/TTNovember/pull/785))
...
* White and transparent colors ;) are supported for the navigation bar ([#789](https://github.com/foosel/TTNovember/pull/789))
* Drag-n-drop overlay for file uploads now uses the full available screen space, improving usability on high resolution
  displays ([#187](https://github.com/foosel/TTNovember/issues/187))
* TTNovember server should no longer hang when big changes in the system time happen, e.g. after first contact to an
...
* Better behaviour of the settings dialog on low-width devices, navigation and content also now scroll independently
  from each other (see also [#823](https://github.com/foosel/TTNovember/pull/823))
...
* Added support for rectangular printer beds with the origin in the center ([#682](https://github.com/foosel/TTNovember/issues/682)
  and [#852](https://github.com/foosel/TTNovember/pull/852)). Printer profiles now contain a new settings ``volume.origin``
...
* Only show configuration options for additional extruders if more than one is available, and don't include offset
  configuration for first nozzle which acts as reference for the other offsets ([#677](https://github.com/foosel/TTNovember/issues/677)).
* Cut off of the temperature graph is now not based on the number of data points any more but on the actual time of the
  ...
  changed under "Temperatures" in the Settings ([#343](https://github.com/foosel/TTNovember/issues/343)).
* High-DPI support for the GCode viewer ([#837](https://github.com/foosel/TTNovember/issues/837)).
* Stop websocket connections from multiplying ([#888](https://github.com/foosel/TTNovember/pull/888)).
* New setting to rotate webcam by 90° counter clockwise ([#895](https://github.com/foosel/TTNovember/issues/895) and
  [#906](https://github.com/foosel/TTNovember/pull/906))
...
* Various improvements of newly introduced features over the course of development:
  ...
  * Plugins: Plugins may now have a folder for plugin related data whose path can be retrieved from the plugin itself
    via its new method [`get_plugin_data_folder`](http://docs.octoprint.org/en/master/modules/plugin.html#octoprint.plugin.types.TTNovemberPlugin.get_plugin_data_folder).
  * Plugin Manager: Don't allow plugin management actions (like installing/uninstalling or enabling/disabling) while the
    printer is printing (see also unreproduced issue [#936](https://github.com/foosel/TTNovember/issues/936)).
...
* [#435](https://github.com/foosel/TTNovember/issues/435) - Always interpret negative duration (e.g. for print time left)
  as 0
* [#516](https://github.com/foosel/TTNovember/issues/516) - Also require API key even if ACL is disabled.
* [#556](https://github.com/foosel/TTNovember/issues/556) - Allow login of the same user from multiple browsers without
  side effects
* [#612](https://github.com/foosel/TTNovember/issues/612) - Fixed GCODE viewer in zoomed out browsers
* [#633](https://github.com/foosel/TTNovember/issues/633) - Correctly interpret temperature lines from multi extruder
  setups under Smoothieware
* [#680](https://github.com/foosel/TTNovember/issues/680) - Don't accidentally include a newline from the MIME headers
  in the parsed multipart data from file uploads
* [#709](https://github.com/foosel/TTNovember/issues/709) - Properly initialize time estimation for SD card transfers too
* [#715](https://github.com/foosel/TTNovember/issues/715) - Fixed an error where Event Triggers of type command caused
  and exception to be raised due to a misnamed attribute in the code
* [#717](https://github.com/foosel/TTNovember/issues/717) - Use ``shutil.move`` instead of ``os.rename`` to avoid cross
  device renaming issues
* [#752](https://github.com/foosel/TTNovember/pull/752) - Fix error in event handlers sending multiple gcode commands.
* [#780](https://github.com/foosel/TTNovember/issues/780) - Always (re)set file position in SD files to 0 so that reprints
  work correctly
* [#784](https://github.com/foosel/TTNovember/pull/784) - Also include ``requirements.txt`` in files packed up for
  ``python setup.py sdist``
* [#330](https://github.com/foosel/TTNovember/issues/330) - Ping pong sending to fix potential acknowledgement errors.
  Also affects [#166](https://github.com/foosel/TTNovember/issues/166), [#470](https://github.com/foosel/TTNovember/issues/470)
  and [#490](https://github.com/foosel/TTNovember/issues/490). A big thank you to all people involved in these tickets
  in getting to the ground of this.
* [#825](https://github.com/foosel/TTNovember/issues/825) - Fixed "please visualize" button of large GCODE files
* Various fixes of bugs in newly introduced features and improvements:
  * [#625](https://github.com/foosel/TTNovember/pull/625) - Newly added GCODE files were not being added to the analysis
    queue
  * [#664](https://github.com/foosel/TTNovember/issues/664) - Fixed jog controls again
  * [#677](https://github.com/foosel/TTNovember/issues/677) - Fixed extruder offsets not being properly editable in
    printer profiles
  * [#678](https://github.com/foosel/TTNovember/issues/678) - SockJS endpoints is now referenced by relative URL
    using ``url_for``, should solve any issues with IE11.
  * [#683](https://github.com/foosel/TTNovember/issues/683) - Fixed heated bed option not being properly displayed in
    printer profiles
  * [#685](https://github.com/foosel/TTNovember/issues/685) - Quoted file name for Timelapse creation to not make
    command hiccup on ``~`` in file name
  * [#709](https://github.com/foosel/TTNovember/issues/709) - Fixed file sending to SD card
  * [#714](https://github.com/foosel/TTNovember/issues/714) - Fixed type validation of printer profiles
  * Heating up the heated bed (if present) was not properly configured in CuraEngine plugin
  * [#720](https://github.com/foosel/TTNovember/issues/720) - Fixed translation files not being properly copied over
    during install
  * [#724](https://github.com/foosel/TTNovember/issues/724) - Fixed timelapse deletion for timelapses with non-ascii
    characters in their name
  * [#726](https://github.com/foosel/TTNovember/issues/726) - Fixed ``babel_refresh`` command
  * [#759](https://github.com/foosel/TTNovember/pull/759) - Properly initialize counter for template plugins of type
    "generic"
  * [#775](https://github.com/foosel/TTNovember/pull/775) - Error messages in javascript console show the proper name
    of the objects
  * [#795](https://github.com/foosel/TTNovember/issues/795) - Allow adding slicing profiles for unconfigured slicers
  * [#809](https://github.com/foosel/TTNovember/issues/809) - Added proper form validation to printer profile editor
  * [#824](https://github.com/foosel/TTNovember/issues/824) - Settings getting lost when switching between panes in
    the settings dialog (fix provided by [#879](https://github.com/foosel/TTNovember/pull/879))
  * [#892](https://github.com/foosel/TTNovember/issues/892) - Preselected baudrate is now properly used for auto detected
    serial ports
  * [#909](https://github.com/foosel/TTNovember/issues/909) - Fixed Z-Timelapse for Z changes on ``G1`` moves.
  * Fixed another instance of a missing `branch` field in version dicts generated by versioneer (compare
    [#634](https://github.com/foosel/TTNovember/pull/634)). Caused an issue when installing from source archive
    downloaded from Github.
  * [#931](https://github.com/foosel/TTNovember/issues/931) - Adjusted `octoprint_setuptools` to be compatible to older
    versions of setuptools potentially site-wide installed on hosts.
  * [#942](https://github.com/foosel/TTNovember/issues/942) - Settings can now be saved again after installing a new
...
### More information
  ...
  * [Commits](https://github.com/foosel/TTNovember/compare/1.1.2...1.2.0)
  * Release Candidates:
    * [RC1](https://github.com/foosel/TTNovember/releases/tag/1.2.0-rc1)
    * [RC2](https://github.com/foosel/TTNovember/releases/tag/1.2.0-rc2)
    * [RC3](https://github.com/foosel/TTNovember/releases/tag/1.2.0-rc3)
...
* Added deletion of `*.pyc` files to `python setup.py clean` command, should help tremendously when switching branches (backported
  from [9e014eb](https://github.com/foosel/TTNovember/commit/9e014eba1feffde11ed0601d9c911b8cac9f3fb0))
* Increased default communication and connection timeouts
* [#706](https://github.com/foosel/TTNovember/issues/706) - Do not truncate error reported from printer

### Bug Fixes

* [#539](https://github.com/foosel/TTNovember/issues/539) - Limit maximum number of tools, sanity check tool numbers in
  GCODE files against upper limit and refuse to create 10000 tools due to weird slicers. (backported from `devel`)
* [#634](https://github.com/foosel/TTNovember/pull/634) - Fixed missing `branch` fields in version dicts generated
  by versioneer
* [#679](https://github.com/foosel/TTNovember/issues/679) - Fix error where API state is requested and printer is offline
  (backport of [619fe9a](https://github.com/foosel/TTNovember/commit/619fe9a0e78826bd1524b235a910156439bcb6d7)).
* [#719](https://github.com/foosel/TTNovember/issues/719) - Properly center print bed in GCODE viewer
* [#780](https://github.com/foosel/TTNovember/issues/780) - Always (re)set file position in SD files to 0 so that reprints
  work correctly (backported from ``devel``)
* [#801](https://github.com/foosel/TTNovember/issues/801) - Fixed setting of bed temperature offset
...
* [unreported] & [#698](https://github.com/foosel/TTNovember/issues/698) - Generated URLs now take X-Forwarded-Host header
  sent by proxies into account for included host and port, also fixed [#698](https://github.com/foosel/TTNovember/issues/698)
  introduced by this
...
* Small fixes for timelapse creation:
  - [#344](https://github.com/foosel/TTNovember/issues/344) - Made timelapses capable of coping with missing captures in between by decrementing the image counter again if there
    was an error fetching the latest image from the snapshot URL (backport of [1a7a468](https://github.com/foosel/TTNovember/commit/1a7a468eb65fdf2a13b4c7a7723280e822c9c34b)
    and [bf9d5ef](https://github.com/foosel/TTNovember/commit/bf9d5efe43a1e57aacd8512125082ddca06b4efc))
  - [#693](https://github.com/foosel/TTNovember/issues/693) -  Try not to capture an image if image counter is still unset
...
([Commits](https://github.com/foosel/TTNovember/compare/1.1.1...1.1.2))
...
* [#580](https://github.com/foosel/TTNovember/issues/580) - Properly unset job data when instructed so by callers
* [#604](https://github.com/foosel/TTNovember/issues/604) - Properly initialize settings basedir on server startup
* [IRC] Also allow downloading .g files via Tornado

([Commits](https://github.com/foosel/TTNovember/compare/1.1.0...1.1.1))
...
* Support for multi extruder setups. With this TTNovember now in theory supports an unlimited amount of extruders, however
  for now it's artificially limited to 9.
* Log files can be accessed from within the browser via the Settings dialog ([#361](https://github.com/foosel/TTNovember/pull/361))
* Timelapses can now have a post-roll duration configured which will be rendered into the video too to not let it
  end so abruptly ([#384](https://github.com/foosel/TTNovember/issues/384))
* The terminal tab now has a command history ([#388](https://github.com/foosel/TTNovember/pull/388))

### Improvements

* Stopping the application via Ctrl-C produces a less scary message ([#277](https://github.com/foosel/TTNovember/pull/277))
* Webcam stream is disabled when control tab is not in focus, reduces bandwidth ([#316](https://github.com/foosel/TTNovember/issues/316))
...
* Added time needed for printing file to PrintDone event's payload ([#333](https://github.com/foosel/TTNovember/issues/333))
* Also provide the filename (basename without the path) in print events
* Support for circular beds in the GCODE viewer ([#407](https://github.com/foosel/TTNovember/pull/407))
* The dimensions of the print bed can now be configured via the Settings ([#396](https://github.com/foosel/TTNovember/pull/396))
* Target temperature reporting format of Repetier Firmware is now supported as well ([360](https://github.com/foosel/TTNovember/issues/360))
...
* Made "Center viewport on model" and "Zoom in on model" in the GCODE viewer automatically deselect and de-apply if
  viewport gets manipulated by the user ([#398](https://github.com/foosel/TTNovember/issues/398))
* GCODE viewer now interprets inverted axes for printer control and mirrors print bed accordingly ([#431](https://github.com/foosel/TTNovember/issues/431))
...
* Made the navbar static instead of fixed to improve usability on mobile devices ([#257](https://github.com/foosel/TTNovember/issues/257))
* Switch to password field upon enter in username field, submit login form upon enter in password field
* Changed default path to TTNovember executable in included init-script to `/usr/local/bin/octoprint` (the default when
  installing via `python setup.py install`)

### Bug Fixes

* Properly calculate time deltas (forgot to factor in days)
* [#35](https://github.com/foosel/TTNovember/issues/35) - GCODE viewer has been modularized, options are now functional
* [#337](https://github.com/foosel/TTNovember/issues/337) - Also recognize `--iknowwhatimdoing` when running as daemon
* [#357](https://github.com/foosel/TTNovember/issues/357) - Do not run GCODE analyzer when a print is ongoing
* [#381](https://github.com/foosel/TTNovember/issues/381) - Only list those SD files that have an ASCII filename
* Fixed a race condition that could occur when pressing "Print" (File not opened yet, but attempt to read from it)
* [#398](https://github.com/foosel/TTNovember/issues/398) - Fixed interfering options in GCODE viewer
* [#399](https://github.com/foosel/TTNovember/issues/399) & [360](https://github.com/foosel/TTNovember/issues/360) - Leave
  bed temperature unset when not detected (instead of dying a horrible death)
* [#492](https://github.com/foosel/TTNovember/issues/492) - Fixed a race condition which could lead to an attempt to read
  from an already closed serial port, causing an error to be displayed to the user
* [#257](https://github.com/foosel/TTNovember/issues/257) - Logging in on mobile devices should now work
* [#476](https://github.com/foosel/TTNovember/issues/476) - Also update the metadata correctly when an analysis finishes
* Various fixes of bugs in newly introduced features and improvements:
  - [#314](https://github.com/foosel/TTNovember/issues/314) - Use G28 for homing (G1 was copy and paste error)
  - [#317](https://github.com/foosel/TTNovember/issues/317) - Fixed "load and print" function
  - [#326](https://github.com/foosel/TTNovember/issues/326) - Fixed refresh of SD file list
  - [#338](https://github.com/foosel/TTNovember/issues/338) - Refetch file list when deleting a file
  - [#339](https://github.com/foosel/TTNovember/issues/339) - More error resilience when handling temperature offset data from the backend
  - [#345](https://github.com/foosel/TTNovember/issues/345) - Also recognize such temperature reports that do not contain a `T:` but a `T0:`
  - [#377](https://github.com/foosel/TTNovember/pull/377) - URLs in API examples fixed
  - [#378](https://github.com/foosel/TTNovember/pull/378) - Fixed crash of API call when `getStartTime()` returns None
  - [#379](https://github.com/foosel/TTNovember/pull/379) - Corrected response code for connection success
  - [#414](https://github.com/foosel/TTNovember/pull/414) - Fix style attribute for Actual column header

([Commits](https://github.com/foosel/TTNovember/compare/1.0.0...1.1.0))
